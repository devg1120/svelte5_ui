import { isFunction, toViewWithLocalDates, toEventWithLocalDates, task, resourceBackgroundColor, resourceTextColor, createEventClasses, createEventContent, setContent, keyEnter, datesEqual, outsideRange, toISOString, addDay, cloneDate, bgEvent, eventIntersects, createEventChunk, sortEventChunks, setPayload, intl, themeView, btnTextDay, btnTextWeek, btnTextMonth, btnTextYear } from '@event-calendar/core';
import { SvelteComponent, init, safe_not_equal, component_subscribe, noop, detach, run_all, attr, insert, append, action_destroyer, listen, is_function, element, space, binding_callbacks, transition_out, transition_in, group_outros, check_outros, empty, ensure_array_like, update_keyed_each, outro_and_destroy_block, destroy_component, mount_component, create_component, destroy_each } from 'svelte/internal';
