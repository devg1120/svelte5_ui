import { createSlotTimeLimits, createTimes, setMidnight, createDate, isFunction, sortEventChunks, setContent, toViewWithLocalDates, toEventWithLocalDates, helperEvent, task, max, resourceBackgroundColor, resourceTextColor, bgEvent, ghostEvent, createEventClasses, createEventContent, keyEnter, datesEqual, outsideRange, addDuration, cloneDate, eventIntersects, createEventChunk, setPayload, rect, floor, ancestor, repositionEvent, height, runReposition, limitToRange, addDay, prepareEventChunks, debounce, toISOString, themeView, btnTextDay, btnTextWeek } from '@event-calendar/core';
import { derived } from 'svelte/store';
import { SvelteComponent, init, safe_not_equal, component_subscribe, ensure_array_like, create_slot, detach, destroy_each, transition_out, transition_in, attr, update_slot_base, get_all_dirty_from_scope, get_slot_changes, insert, append, action_destroyer, element, space, is_function, set_store_value, destroy_component, mount_component, create_component, binding_callbacks, empty, construct_svelte_component, run_all, group_outros, check_outros, listen, noop, set_style, update_keyed_each, outro_and_destroy_block } from 'svelte/internal';
