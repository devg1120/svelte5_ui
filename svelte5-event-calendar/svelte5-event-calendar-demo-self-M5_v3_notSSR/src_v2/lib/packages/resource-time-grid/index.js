import { isFunction, toLocalDate, setContent, toISOString, viewResources, themeView, btnTextDay, btnTextWeek } from '@event-calendar/core';
import TimeGrid, { Section, Body, Day, Week } from '@event-calendar/time-grid';
import { SvelteComponent, init, safe_not_equal, component_subscribe, noop, detach, attr, insert, action_destroyer, element, binding_callbacks, is_function, destroy_component, transition_out, transition_in, group_outros, check_outros, mount_component, append, create_component, space, ensure_array_like, destroy_each, empty } from 'svelte/internal';
