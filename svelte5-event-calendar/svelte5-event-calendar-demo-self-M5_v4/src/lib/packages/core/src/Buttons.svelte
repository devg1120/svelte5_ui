...
{#each buttons as button}
  ...
  {:else if button == "prev"}
    <button
      ...
      onclick={prev}
      disabled={prevDisabled}><i class="{$theme.icon} ec-{button}"></i></button
    >
  {:else if button == "next"}
    <button
      class="{$theme.button} ec-{button}"
      ...
      onclick={next}
      disabled={nextDisabled}><i class="{$theme.icon} ec-{button}"></i></button
    >
  {:else if button == "today"}
    <button
      class="{$theme.button} ec-{button}"
      onclick={() => ($date = cloneDate(today))}
      disabled={todayDisabled}>{$buttonText[button]}</button
    >
