...
import TimeGrid, { Section, Body, Day, Week } from "@event-calendar/time-grid";
import {
  SvelteComponent,
  init,
  safe_not_equal,
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, resourceLabelContent, (value) =>
    $$invalidate(8, ($resourceLabelContent = value)),
  );
  component_subscribe($$self, resourceLabelDidMount, (value) =>
    $$invalidate(11, ($resourceLabelDidMount = value)),
  );
  component_subscribe($$self, _intlDayHeaderAL, (value) =>
    $$invalidate(10, ($_intlDayHeaderAL = value)),
  );
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (
        !current ||
        (dirty[0] & /*$theme*/ 32 &&
          div_class_value !== (div_class_value = /*$theme*/ ctx[5].day))
      ) {
  ...
  return {
    c() {
      ...
      attr(
        time,
        "datetime",
        (time_datetime_value = toISOString(/*item0*/ ctx[17], 10)),
      );
      attr(
        time,
        "aria-label",
        (time_aria_label_value = /*$_intlDayHeaderAL*/ ctx[6].format(
          /*item0*/ ctx[17],
        )),
      );
      attr(
        ...
        (div_class_value =
          ...
          /*$theme*/ (ctx[5].day +
            " " +
            /*$theme*/ ctx[5].weekdays?.[/*item0*/ ctx[17].getUTCDay()])),
      );
    },
    m(target, anchor) {
      insert(target, div, anchor);
      ...
      if (!mounted) {
        dispose = action_destroyer(
          (setContent_action = setContent.call(
            null,
            time,
            /*$_intlDayHeader*/ ctx[7].format(/*item0*/ ctx[17]),
          )),
        );
        mounted = true;
      }
    ...
    p(new_ctx, dirty) {
      ...
      if (
        dirty[0] & /*$_intlDayHeaderAL, loops*/ 72 &&
      ...
      if (
        setContent_action &&
        is_function(setContent_action.update) &&
        dirty[0] & /*$_intlDayHeader, loops*/ 136
      )
...
function create_if_block_2(ctx) {
  ...
  for (let i = 0; i < each_value_6.length; i += 1) {
    each_blocks[i] = create_each_block_6(
  ...
  return {
    ...
    p(ctx, dirty) {
      if (
        dirty[0] &
        /*$theme, loops, $datesAboveResources, resourceLabels, $_intlDayHeaderAL, $_intlDayHeader*/ 252
      ) {
      ...
      if (
        !current ||
        (dirty[0] & /*$theme*/ 32 &&
          div_class_value !== (div_class_value = /*$theme*/ ctx[5].days))
      ) {
        attr(div, "class", div_class_value);
      }
    },
  ...
  return {
    c() {
      ...
      attr(
        time,
        "datetime",
        (time_datetime_value = toISOString(/*item1*/ ctx[20], 10)),
      );
      attr(
        time,
        "aria-label",
        (time_aria_label_value =
          "" +
          /*resourceLabels*/ (ctx[4][/*i*/ ctx[32]] +
            /*$_intlDayHeaderAL*/ ctx[6].format(/*item1*/ ctx[20]))),
      );
      attr(
        div,
        "class",
        (div_class_value =
          ...
          /*$theme*/ (ctx[5].day +
            " " +
            /*$theme*/ ctx[5].weekdays?.[/*item1*/ ctx[20].getUTCDay()])),
      );
      ...
      if (!mounted) {
        dispose = action_destroyer(
          (setContent_action = setContent.call(
            null,
            time,
            /*$_intlDayHeader*/ ctx[7].format(/*item1*/ ctx[20]),
          )),
        );
        mounted = true;
      }
    ...
    p(new_ctx, dirty) {
      ...
      if (
        dirty[0] & /*resourceLabels, $_intlDayHeaderAL, loops*/ 88 &&
        time_aria_label_value !==
          (time_aria_label_value =
            "" +
            /*resourceLabels*/ (ctx[4][/*i*/ ctx[32]] +
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (
        !current ||
        (dirty[0] & /*$theme*/ 32 &&
          div_class_value !== (div_class_value = /*$theme*/ ctx[5].resource))
      ) {
        attr(div, "class", div_class_value);
      }
    },
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (
        (dirty[0] &
          /*$_viewDates, $theme, $_viewResources, $datesAboveResources*/ 39) |
        (dirty[1] & /*$$scope*/ 16)
      ) {
      ...
      if (
        ...
        (dirty[0] & /*$theme*/ 32 &&
          div0_class_value !==
            (div0_class_value = /*$theme*/ ctx[5].hiddenScroll))
      ) {
      ...
      if (
        !current ||
        (dirty[0] & /*$theme*/ 32 &&
          div1_class_value !== (div1_class_value = /*$theme*/ ctx[5].content))
      ) {
      ...
      if (
        !current ||
        (dirty[0] & /*$theme*/ 32 &&
          div2_class_value !== (div2_class_value = /*$theme*/ ctx[5].allDay))
      ) {
...
function create_each_block_4(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      const week_changes = {};
      if (dirty[0] & /*$_viewDates*/ 1)
        week_changes.dates = /*$_viewDates*/ ctx[0];
      if (dirty[0] & /*$_viewResources*/ 2)
        week_changes.resource = /*resource*/ ctx[26];
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (dirty[0] & /*$datesAboveResources, loops*/ 12)
        day_changes.date = /*$datesAboveResources*/ ctx[2]
          ? /*item0*/ ctx[17]
          : /*item1*/ ctx[20];

      if (dirty[0] & /*$datesAboveResources, loops*/ 12)
        day_changes.resource = /*$datesAboveResources*/ ctx[2]
          ? /*item1*/ ctx[20]
          : /*item0*/ ctx[17];
...
function create_fragment(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      if (
        (dirty[0] &
          /*loops, $theme, $datesAboveResources, resourceLabels, $_intlDayHeaderAL, $_intlDayHeader*/ 252) |
        (dirty[1] & /*$$scope*/ 16)
      ) {
        section_changes.$$scope = { dirty, ctx };
      }
      ...
      if (
        !current ||
        (dirty[0] & /*$theme*/ 32 &&
          div1_class_value !== (div1_class_value = /*$theme*/ ctx[5].header))
      ) {
        attr(div1, "class", div1_class_value);
      }
      ...
      if (
        (dirty[0] & /*loops, $theme, $datesAboveResources*/ 44) |
        (dirty[1] & /*$$scope*/ 16)
      ) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, datesAboveResources, (value) =>
    $$invalidate(2, ($datesAboveResources = value)),
  );
  component_subscribe($$self, _viewDates, (value) =>
    $$invalidate(0, ($_viewDates = value)),
  );
  component_subscribe($$self, _viewResources, (value) =>
    $$invalidate(1, ($_viewResources = value)),
  );
  component_subscribe($$self, _intlDayHeader, (value) =>
    $$invalidate(7, ($_intlDayHeader = value)),
  );
  component_subscribe($$self, _intlDayHeaderAL, (value) =>
    $$invalidate(6, ($_intlDayHeaderAL = value)),
  );
  component_subscribe($$self, allDaySlot, (value) =>
    $$invalidate(8, ($allDaySlot = value)),
  );
  ...
  let loops;
  let resourceLabels = [];
  const text_handler = (i, e) =>
    $$invalidate(4, (resourceLabels[i] = e.detail + ", "), resourceLabels);

  $$self.$$.update = () => {
    if (
      $$self.$$.dirty[0] &
      /*$datesAboveResources, $_viewDates, $_viewResources*/ 7
    ) {
      $$invalidate(
        3,
